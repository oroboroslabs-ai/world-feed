    ...
    const SEED = [
        {
            ...
            body: 'Anthropic has announced Claude 4, featuring significant improvements in reasoning, coding, and long-context understanding. The model demonstrates enhanced safety measures and better alignment with human values.',
        ...
        },
        {
            ...
            tier: 5,
            cats: ['verified', 'docs'],
            title: 'Anthropic publishes new research on AI safety and interpretability',
            body: 'New research from Anthropic explores methods for understanding and controlling large language models. The work focuses on mechanistic interpretability and scalable oversight techniques.',
        ...
        },
        {
            ...
            tier: 5,
            cats: ['new', 'verified', 'developing'],
            title: 'Constitutional AI: Anthropic\'s approach to building helpful, harmless, and honest AI',
            body: 'Anthropic\'s Constitutional AI methodology uses explicit principles to guide AI behavior, reducing the need for human oversight while maintaining safety and alignment.',
            sources: ['Anthropic', 'AI Safety'],
            type: 'story',
            minutesAgo: 55,
        ...
        },
        {
            ...
            tier: 5,
            cats: ['verified', 'docs'],
            title: 'Claude for Enterprise: Anthropic expands business offerings',
            body: 'Anthropic launches Claude for Enterprise with enhanced security features, custom deployment options, and enterprise-grade support for large organizations.',
        ...
        },
        {
            ...
            tier: 5,
            cats: ['verified', 'docs'],
            title: 'Anthropic API now supports longer context windows and faster responses',
            body: 'The Anthropic API has been updated with support for 200K token context windows, improved response times, and new features for developers building AI applications.',
        ...
        },
        {
            ...
            title: 'Anthropic team grows with leading AI researchers joining from top institutions',
            body: 'Anthropic continues to attract top talent in AI safety and machine learning, strengthening its research capabilities and commitment to beneficial AI development.',
            sources: ['Anthropic', 'AI Research'],
            type: 'story',
            minutesAgo: 130,
            location: 'Team',
            imageUrl: '',
        ...
        },
        {
            ...
            tier: 4,
            cats: ['developing'],
            title: 'Anthropic announces strategic partnerships for AI safety research',
            body: 'New partnerships with academic institutions and research organizations aim to advance AI safety, interpretability, and alignment research globally.',
            sources: ['Anthropic', 'Partnerships'],
            type: 'story',
            minutesAgo: 165,
        ...
        {
            id: 'anthropic-mission',
            tier: 4,
            cats: ['developing', 'docs'],
            title: 'Anthropic\'s mission: Building reliable, interpretable, and steerable AI systems',
            body: 'Anthropic focuses on developing AI systems that are safe, beneficial, and understandable, prioritizing long-term AI safety research over short-term commercial gains.',
            sources: ['Anthropic Mission'],
            type: 'story',
            minutesAgo: 210,
            location: 'Mission',
            imageUrl: '',
            videoUrl: '',
            link: 'https://www.anthropic.com/about'
        }
    ];
